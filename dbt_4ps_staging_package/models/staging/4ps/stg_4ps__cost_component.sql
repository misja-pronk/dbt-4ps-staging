select
    ...
    `CostComponentAddCost-30` as `cost_component_add_cost`,
    `AdditionalCostService-50` as `additional_cost_service`,
...
from
    stream read_files(
        '/Volumes/{{ var("source")["database"] }}/{{ var("source")["schema"] }}/{{ var("source")["volume"] }}/deltas/CostComponent-11012012/*.csv',
        schema
        => '`Code-10` string, `Description-20` string, `CostComponentAddCost-30` string, `AdditionalCostService-50` boolean, `ExporttoFSA-11012990` boolean, `DateTimeExporttoFSA-11012991` timestamp, `timestamp-0` bigint, `systemId-2000000000` string, `SystemCreatedAt-2000000001` timestamp, `SystemCreatedBy-2000000002` string, `SystemModifiedAt-2000000003` timestamp, `SystemModifiedBy-2000000004` string, `$Company` string',
        header => 'true',
        sep => ',',
        escape => '\\',
        encoding => 'UTF-8',
